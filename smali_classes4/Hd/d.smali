...
# direct methods
.method public static a(Lud/f$a;)V
    .locals 10
    ...
    :cond_0
    invoke-static {v4}, Ljc/z;->j(Ljava/lang/String;)Z
    ...
    iput-object v0, p0, Lud/f;->r0:Lud/f$a;
    ...
    iget-object v0, p0, Lud/f$a;->a:Lud/f;

    iget-object v1, v0, Lud/f;->C:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0}, Lud/f;->s()V

    goto :goto_1

    :cond_4
    iget-object v1, v0, Lud/f;->A:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v1, v0, Lud/f;->r:LAd/j;

    iget-object v1, v1, LAd/j;->a:LAd/i;

    iput-object v1, v0, Lud/f;->d0:LAd/i;
    ...
    iget-object v0, v0, Lud/f;->q:Lcom/faceunity/core/faceunity/FUAIKit;
...
.method public static b(Ljava/lang/String;Lud/f$a;)V
    .locals 13
    ...
    invoke-direct/range {v6 .. v11}, LHd/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lud/f$a;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-static {v12, v3}, LBc/a;->A(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct/range {v3 .. v9}, LHd/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lud/f$a;Ljava/util/concurrent/atomic/AtomicInteger;)V

    invoke-static {v12, p0}, LBc/a;->A(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
