...
.method private createCornerAnimator(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v0, p1, v1}, Lcom/android/camera/ui/E;-><init>(Ljava/lang/Object;I)V
...
.method private getRoundedCornerRadius(Landroid/view/WindowInsets;I)I
    ...
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/analytics/O;->c(Landroid/view/WindowInsets;I)Landroid/view/RoundedCorner;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0}, LBh/b;->a(Landroid/view/RoundedCorner;)I
