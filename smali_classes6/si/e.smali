...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lsi/e;->k:Landroidx/vectordrawable/graphics/drawable/ArgbEvaluator;

    new-instance v3, Lsi/e$a;
    ...
    iput-object v3, p0, Lsi/e;->A:Lsi/e$a;
    ...
    iput-object v3, p0, Lsi/e;->u:Landroid/graphics/Paint;
    ...
    iput v0, p0, Lsi/e;->h:F

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    iget p1, p0, Lsi/e;->l:I

    invoke-virtual {p0, p1}, Lsi/e;->setSize(I)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    :goto_0
    iput-boolean v1, p0, Lsi/e;->x:Z

    iget v0, p0, Lsi/e;->r:I

    int-to-float v0, v0

    iget v3, p0, Lsi/e;->b:F

    add-float/2addr v0, v3

    iget v4, p0, Lsi/e;->m:F

    add-float/2addr v4, v3

    iget v3, p0, Lsi/e;->s:I

    iget v5, p0, Lsi/e;->t:I

    iget-object v6, p0, Lsi/e;->k:Landroidx/vectordrawable/graphics/drawable/ArgbEvaluator;

    if-eqz v1, :cond_3

    :goto_1
    iget v1, p0, Lsi/e;->a:I

    if-ge v2, v1, :cond_6

    iget v7, p0, Lsi/e;->i:I
...
.method public final onMeasure(II)V
    ...
    iget p1, p0, Lsi/e;->a:I

    add-int/lit8 p1, p1, -0x1

    int-to-float p1, p1

    iget p2, p0, Lsi/e;->e:F

    mul-float/2addr p1, p2

    iget p2, p0, Lsi/e;->b:F
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v2, p0, Lsi/e;->r:I

    int-to-float v2, v2

    iget v5, p0, Lsi/e;->a:I
    ...
    iget v6, p0, Lsi/e;->b:F

    mul-float v7, v6, v3

    iget v8, p0, Lsi/e;->f:F
    ...
    :cond_3
    :goto_2
    iget-object v0, p0, Lsi/e;->y:Lsi/e$b;
...
.method public setBackgroundVisible(Z)V
    ...
    iget-boolean v0, p0, Lsi/e;->w:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Lsi/e;->w:Z

    invoke-virtual {p0, p1}, Lsi/e;->setBackgroundVisibleInternal(Z)V
...
.method public setBackgroundVisibleInternal(Z)V
    ...
    iget-object v0, p0, Lsi/e;->A:Lsi/e$a;
...
.method public setCurrentPosition(I)V
    ...
    iget v0, p0, Lsi/e;->i:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lsi/e;->i:I
...
.method public setCurrentPositionOffset(F)V
    ...
    iget v0, p0, Lsi/e;->j:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, Lsi/e;->j:F
...
.method public setOnPageChangeListener(Lsi/e$b;)V
    .locals 0

    iput-object p1, p0, Lsi/e;->y:Lsi/e$b;
...
.method public setSize(I)V
    ...
    :cond_0
    iput p1, p0, Lsi/e;->l:I

    if-nez p1, :cond_1

    iget p1, p0, Lsi/e;->c:F

    iput p1, p0, Lsi/e;->b:F

    iget p1, p0, Lsi/e;->n:F

    iput p1, p0, Lsi/e;->m:F

    iget p1, p0, Lsi/e;->p:I

    iput p1, p0, Lsi/e;->r:I

    iget p1, p0, Lsi/e;->g:F

    iput p1, p0, Lsi/e;->f:F

    goto :goto_0

    :cond_1
    iget p1, p0, Lsi/e;->d:F

    iput p1, p0, Lsi/e;->b:F

    iget p1, p0, Lsi/e;->o:F

    iput p1, p0, Lsi/e;->m:F

    iget p1, p0, Lsi/e;->q:I

    iput p1, p0, Lsi/e;->r:I

    iget p1, p0, Lsi/e;->h:F
    ...
    iget v0, p0, Lsi/e;->b:F

    mul-float/2addr v0, p1

    iget p1, p0, Lsi/e;->f:F

    add-float/2addr v0, p1

    iput v0, p0, Lsi/e;->e:F
