...
.method public constructor <init>(Lcom/android/camera/module/Camera2Module;)V
    ...
    iput v0, p0, Lv3/p;->a:I

    const/4 v1, 0x0

    iput v1, p0, Lv3/p;->b:I

    iput-boolean v1, p0, Lv3/p;->d:Z

    iput-boolean v1, p0, Lv3/p;->f:Z

    iput-boolean v0, p0, Lv3/p;->g:Z

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lv3/p;->j:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lv3/p;Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    ...
    :try_start_0
    sget-object v1, LA/c3;->a:LA/c3$a;
    ...
    iget-object p0, v1, LA/c3$a;->b:Ljava/text/SimpleDateFormat;
...
# virtual methods
.method public final b()Lv3/p$c;
    .locals 2

    iget-object v0, p0, Lv3/p;->k:Lv3/p$c;

    if-nez v0, :cond_0

    new-instance v0, Lv3/p$c;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lv3/p$c;-><init>(Lv3/p;Landroid/os/Looper;)V

    iput-object v0, p0, Lv3/p;->k:Lv3/p$c;

    :cond_0
    iget-object p0, p0, Lv3/p;->k:Lv3/p$c;
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lv3/p;->c:Z

    invoke-virtual {p0}, Lv3/p;->d()V

    :cond_0
    iget-boolean v0, p0, Lv3/p;->d:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lv3/p;->b()Lv3/p$c;
    ...
    :cond_1
    iget-object v0, p0, Lv3/p;->e:Ljava/lang/Boolean;
...
.method public final d()V
    ...
    iget-object p0, p0, Lv3/p;->j:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v0}, L롅롉롋레롋롏레롂롃롐롏롅롃레롅롉롋롋롉롈레롥롉롋롋롉롈;->p4()Z
...
.method public final e()V
    ...
    iget-object v1, p0, Lv3/p;->j:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    iget-object v2, p0, Lv3/p;->i:Lio/reactivex/ObservableEmitter;
    ...
    :cond_1
    iget-object v2, p0, Lv3/p;->l:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v3, p0, Lv3/p;->l:Lio/reactivex/disposables/Disposable;

    :cond_2
    iget-boolean v2, p0, Lv3/p;->d:Z
    ...
    iput-boolean v0, p0, Lv3/p;->d:Z

    :cond_4
    iput-object v3, p0, Lv3/p;->e:Ljava/lang/Boolean;
