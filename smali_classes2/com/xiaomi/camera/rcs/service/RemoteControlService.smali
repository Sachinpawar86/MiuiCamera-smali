...
.method public static a(Lcom/xiaomi/camera/rcs/service/RemoteControlService;Lcom/xiaomi/camera/rcs/service/RemoteControlService$b;)V
    ...
    sget-object v5, Lzb/h;->a:Ljava/lang/String;
    ...
    invoke-static {p1, v2, v0, p0}, LFb/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static b(Lcom/xiaomi/camera/rcs/service/RemoteControlService;ILjava/lang/String;)V
    ...
    :cond_0
    invoke-virtual {p0}, LEb/a;->g()V

    :goto_0
    if-eqz p1, :cond_4

    iget-object p1, p0, LEb/a;->e:LEb/a$c;

    if-nez p1, :cond_1

    :try_start_0
    new-instance p1, LEb/a$c;

    invoke-direct {p1, p0}, LEb/a$c;-><init>(LEb/a;)V

    iput-object p1, p0, LEb/a;->e:LEb/a$c;

    invoke-virtual {p1}, LEb/a$c;->a()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p2, v3, p1}, LFb/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-virtual {p0, v2}, LEb/a;->e(I)V
...
.method public static e(Landroid/content/Context;Ljava/lang/String;)Ljava/util/HashSet;
    ...
    invoke-static {v0, p0}, LFb/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c(Landroid/os/IBinder;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/camera/rcs/service/RemoteControlService$b;->a:Lzb/c;
    ...
    iget-object v0, v0, Lcom/xiaomi/camera/rcs/service/RemoteControlService;->e:LEb/a;

    if-eqz v0, :cond_0

    iget-object v2, v0, LEb/a;->b:Ljava/util/LinkedList;

    monitor-enter v2

    :try_start_1
    iget-object v0, v0, LEb/a;->b:Ljava/util/LinkedList;
...
.method public final onCreate()V
    ...
    invoke-static {p0}, Lzb/g;->b(Landroid/content/Context;)I
    ...
    invoke-direct {v0, p0, p0}, LEb/a;-><init>(Lcom/xiaomi/camera/rcs/service/RemoteControlService;Lcom/xiaomi/camera/rcs/service/RemoteControlService;)V

    iput-object v0, p0, Lcom/xiaomi/camera/rcs/service/RemoteControlService;->e:LEb/a;
...
.method public final onDestroy()V
    ...
    iget-object v3, p0, Lcom/xiaomi/camera/rcs/service/RemoteControlService;->e:LEb/a;

    if-eqz v3, :cond_0

    invoke-virtual {v3}, LEb/a;->g()V

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/xiaomi/camera/rcs/service/RemoteControlService;->e:LEb/a;
