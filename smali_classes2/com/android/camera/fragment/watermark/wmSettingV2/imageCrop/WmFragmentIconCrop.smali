...
# virtual methods
.method public final K9(Landroid/graphics/Bitmap;)V
    .locals 8
    ...
    invoke-static {}, LK2/m;->b()Landroid/graphics/Bitmap$CompressFormat;
    ...
    invoke-static {v4, v5}, LA/G2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, v0, LK2/l;->a:LK2/l$a;

    if-eqz v2, :cond_7

    invoke-interface {v2, p1}, LK2/l$a;->a(Landroid/net/Uri;)V

    iput-object v1, v0, LK2/l;->a:LK2/l$a;

    :cond_7
    invoke-virtual {p0}, Lcom/android/camera/fragment/watermark/wmSettingV2/imageCrop/WmFragmentIconCrop;->Y9()V
...
.method public final p8(Landroid/view/View;)V
    ...
    invoke-static {v2, p1}, LK2/l;->a(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    :try_start_3
    invoke-static {v1, v3}, Laa/D;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_3
