...
.method public final J2(Landroid/content/Context;I)V
    ...
    invoke-static {p2, p1}, LA/R3;->e(IZ)V
    ...
    iget-object v0, p0, Lcom/android/camera/module/video/q;->b:LA/e0;
    ...
    new-instance v4, LA/e0$a;

    invoke-direct {v4, v0}, LA/e0$a;-><init>(LA/e0;)V

    iput-object v4, v0, LA/e0;->f:LA/e0$a;

    const/4 v4, 0x0

    iput-object v4, v0, LA/e0;->a:Landroid/media/AudioTrack;

    iput-boolean v2, v0, LA/e0;->d:Z
    ...
    iput v4, v0, LA/e0;->b:I

    if-lez v4, :cond_2

    new-array v4, v4, [S

    iput-object v4, v0, LA/e0;->c:[S
    ...
    :goto_2
    iput-object v0, p0, Lcom/android/camera/module/video/q;->b:LA/e0;
    ...
    :cond_4
    iput-boolean p1, p0, Lcom/android/camera/module/video/q;->a:Z

    iget-object p0, p0, Lcom/android/camera/module/video/q;->b:LA/e0;

    if-eqz p0, :cond_8

    iget-boolean v0, p0, LA/e0;->d:Z

    if-nez v0, :cond_8

    iput-boolean p1, p0, LA/e0;->d:Z
    ...
    iget-object p1, p0, LA/e0;->e:Ljava/lang/Thread;
    ...
    iget-object v0, p0, LA/e0;->f:LA/e0$a;

    invoke-direct {p1, v0}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    iput-object p1, p0, LA/e0;->e:Ljava/lang/Thread;

    :cond_7
    iget-object p0, p0, LA/e0;->e:Ljava/lang/Thread;
...
.method public final Lf()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/module/video/q;->c:Z

    return p0
.end method

.method public final S6(Landroid/content/Context;I)V
    .locals 5
    ...
    invoke-static {p2, v0}, LA/R3;->e(IZ)V
    ...
    iget-boolean v1, p0, Lcom/android/camera/module/video/q;->a:Z

    if-eqz v1, :cond_4

    iput-boolean v0, p0, Lcom/android/camera/module/video/q;->a:Z

    iget-object p0, p0, Lcom/android/camera/module/video/q;->b:LA/e0;

    if-eqz p0, :cond_2

    iget-boolean v1, p0, LA/e0;->d:Z

    if-eqz v1, :cond_2

    iput-boolean v0, p0, LA/e0;->d:Z
    ...
    iget-object v1, p0, LA/e0;->e:Ljava/lang/Thread;
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, LA/e0;->a:Landroid/media/AudioTrack;
    ...
    iget-object v2, p0, LA/e0;->a:Landroid/media/AudioTrack;
    ...
    iput-object v1, p0, LA/e0;->a:Landroid/media/AudioTrack;
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_1
...
.method public final onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-boolean v2, p0, Lcom/android/camera/module/video/q;->c:Z

    iget-object p2, p0, Lcom/android/camera/module/video/q;->d:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->w9()I

    move-result p2

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/module/video/q;->S6(Landroid/content/Context;I)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/module/video/q;->c:Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/module/video/q;->J2(Landroid/content/Context;I)V
