...
.method public final onImageReceived(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    instance-of v3, v1, Lv3/p$b;

    if-eqz v3, :cond_2

    check-cast v1, Lv3/p$b;

    iget-boolean v3, v2, Laa/o;->C:Z

    iget-object v1, v1, Lv3/p$b;->e:Lv3/p;

    iget-boolean v4, v1, Lv3/p;->g:Z
    ...
    :cond_0
    iput-boolean v3, v1, Lv3/p;->g:Z

    invoke-virtual {v1}, Lv3/p;->b()Lv3/p$c;
    ...
    invoke-static {v7, v3}, LA/w3;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v1, v0, LZ5/j0;->h:Ll4/k;

    if-nez v1, :cond_4

    const-string p0, "notifyResultData: null parallel callback"

    invoke-static {v7, p0}, LA/G2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
