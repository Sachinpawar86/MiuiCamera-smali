...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ll4/q;->a:Ljava/io/File;
...
.method public static final a(Lcom/android/camera/storage/MigrateWorker;)Z
    ...
    sget-object v2, Ll4/q;->a:Ljava/io/File;
    ...
    iput-boolean v1, v3, Lkotlin/jvm/internal/z;->a:Z
    ...
    invoke-direct {v4, v5}, LLa/f;-><init>(I)V

    new-instance v5, Lcom/android/camera/fragment/C;

    invoke-direct {v5, v4, v1}, Lcom/android/camera/fragment/C;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v2, v5}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v4

    new-instance v5, LLa/h;

    invoke-direct {v5, p0, v0}, LLa/h;-><init>(Ljava/lang/Object;I)V

    new-instance v6, LA3/m0;

    invoke-direct {v6, v5, v0}, LA3/m0;-><init>(Ljava/lang/Object;I)V

    invoke-static {v4, v6}, Ll4/p;->a(Ljava/util/stream/Stream;LA3/m0;)Ljava/util/stream/Stream;

    move-result-object v0

    new-instance v4, Lcom/android/camera2/compat/theme/custom/mm/top/c1;

    invoke-direct {v4, v1, v3, p0}, Lcom/android/camera2/compat/theme/custom/mm/top/c1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance p0, LA/L0;

    const/16 v1, 0x18

    invoke-direct {p0, v4, v1}, LA/L0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v2, p0}, LBc/a;->k(Ljava/lang/AutoCloseable;Ljava/lang/Throwable;)V

    iget-boolean v1, v3, Lkotlin/jvm/internal/z;->a:Z
...
.method public static final b(Ljava/io/File;Lcom/android/camera/storage/MigrateWorker;)Z
    ...
    invoke-direct {v4, v3, v5}, Ll4/m;-><init>(Landroid/net/Uri;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-static {v2, v8}, Laa/D;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :cond_3
    iget-object v4, v8, Ll4/m;->a:Landroid/net/Uri;

    iget-object v5, v8, Ll4/m;->b:Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p0, v4}, Ll4/q;->c(Ljava/io/File;Landroid/net/Uri;)V
...
.method public static final c(Ljava/io/File;Landroid/net/Uri;)V
    ...
    invoke-static {v0, p1, v1}, LBc/a;->o(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-static {p1, v1}, Laa/D;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p0}, Laa/D;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
