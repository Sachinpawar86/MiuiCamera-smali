...
.method public constructor <init>(LTa/f;)V
    ...
    iput-object p1, p0, LTa/f$a;->c:LTa/f;

    invoke-direct {p0, p1}, LTa/d$d;-><init>(LTa/f;)V
...
.method public final onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    iget-object p0, p0, LTa/f$a;->c:LTa/f;
    ...
    iget-boolean p1, p0, LTa/i$c;->a:Z
    ...
    :cond_2
    iget-object p1, p0, LTa/i$c;->b:LTa/g;

    iget-object v0, p1, LTa/i;->j:[I
    ...
    :catch_0
    iput p0, p1, LTa/i;->c:I

    :goto_0
    iget v0, p1, LTa/i;->e:I

    new-array v0, v0, [I

    iput-object v0, p1, LTa/i;->j:[I

    iget v0, p1, LTa/i;->d:I
    ...
    invoke-static {v0, v1, v2}, LVa/a;->l(ILjava/lang/String;Ljava/lang/String;)V

    iget-object v1, p1, LTa/i;->g:Landroid/media/MediaMuxer;
    ...
    iget-object v3, p1, LTa/i;->g:Landroid/media/MediaMuxer;
    ...
    :cond_6
    iget-object p2, p1, LTa/i;->g:Landroid/media/MediaMuxer;

    invoke-virtual {p2}, Landroid/media/MediaMuxer;->start()V

    iget-object p2, p1, LTa/i;->i:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {p2, p0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p1}, LTa/i;->d()V
