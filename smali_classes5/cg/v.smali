...
.method public static v(LPf/M;)LPf/M;
    ...
    :cond_1
    invoke-static {v0}, Llf/u;->t0(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method public final i(Lyg/d;Lyg/j$a$a;)Ljava/util/Set;
    ...
    invoke-static {p1}, Llf/u;->t0(Ljava/lang/Iterable;)Ljava/util/Set;

    move-result-object p1

    iget-object p2, p0, Lcg/v;->o:Lcg/e;

    invoke-static {p2}, LF2/a;->i(LPf/e;)Lcg/v;
...
.method public final m(Ljava/util/LinkedHashSet;Log/f;)V
    ...
    invoke-static/range {v2 .. v7}, LAe/b;->j(Log/f;Ljava/util/Collection;Ljava/util/AbstractCollection;Lcg/e;LUf/h;Lrg/m;)Ljava/util/LinkedHashSet;
...
.method public final n(Ljava/util/ArrayList;Log/f;)V
    ...
    invoke-static/range {v1 .. v6}, LAe/b;->j(Log/f;Ljava/util/Collection;Ljava/util/AbstractCollection;Lcg/e;LUf/h;Lrg/m;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v1}, Llf/r;->F(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-static {p1, v0}, LK3/a;->a(Ljava/util/AbstractCollection;Ljava/lang/Object;)V
