...
.method public constructor <init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    iput-object v0, p0, LJ/o;->d:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, LJ/o;->a:Landroid/view/View;

    if-nez v0, :cond_0

    invoke-interface {p0}, LJ/f;->getId()I
    ...
    :cond_0
    iget-object p1, p0, LJ/o;->a:Landroid/view/View;
    ...
    iput-object p1, p0, LJ/o;->b:Landroid/view/ViewGroup;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iput-object p1, p0, LJ/o;->i:Ljava/lang/StringBuilder;
...
.method public d(FILH/m;Landroid/graphics/Rect;)Landroid/widget/FrameLayout$LayoutParams;
    .locals 0
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
...
.method public e(FILH/m;Landroid/graphics/Rect;)V
    .locals 7

    iget-object p1, p0, LJ/o;->a:Landroid/view/View;

    iget-object p3, p0, LJ/o;->b:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object v0, p0, LJ/o;->c:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, LJ/o;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, LJ/o;->c:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, LJ/o;->c:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1, p4, v0}, LJ/o;->l(ILandroid/graphics/Rect;Landroid/util/Size;)V
...
.method public h(LH/m;)V
    .locals 1

    iget-object p1, p0, LJ/o;->a:Landroid/view/View;

    iget-object v0, p0, LJ/o;->i:Ljava/lang/StringBuilder;

    invoke-virtual {p1, v0}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object p0, p0, LJ/o;->i:Ljava/lang/StringBuilder;
...
.method public final k(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    iget-object p1, p0, LJ/o;->i:Ljava/lang/StringBuilder;
