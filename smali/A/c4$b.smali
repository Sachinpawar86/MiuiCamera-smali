...
# direct methods
.method public constructor <init>(ZZLjava/lang/ref/WeakReference;LA/c4;LA/Y3;)V
    .locals 1
    ...
    iput v0, p0, LA/c4$b;->n:I

    iput-boolean p1, p0, LA/c4$b;->h:Z

    iput-boolean p2, p0, LA/c4$b;->i:Z

    iput-object p3, p0, LA/c4$b;->k:Ljava/lang/ref/WeakReference;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p4}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LA/c4$b;->l:Ljava/lang/ref/WeakReference;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p5}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LA/c4$b;->m:Ljava/lang/ref/WeakReference;
...
.method public final e([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-boolean v3, v1, LA/c4$b;->h:Z
    ...
    iget-object v2, v1, LA/c4$b;->k:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v6}, LA/Y3;->h(Landroid/content/ContentResolver;)LA/Y3$a;
    ...
    :cond_2
    iget-object v8, v7, LA/Y3$a;->d:Landroid/net/Uri;

    :goto_2
    const-string v9, "LoadThumbnailTask: lastUri = "

    invoke-static {v8, v9}, LA/z2;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v1, LA/c4$b;->m:Ljava/lang/ref/WeakReference;
    ...
    iget-object v12, v9, LA/Y3;->a:Landroid/net/Uri;

    const-string v13, "LoadThumbnailTask: thumbnailUri = "

    invoke-static {v12, v13}, LA/z2;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v12}, Ljc/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    :cond_3
    iget-wide v14, v7, LA/Y3$a;->j:J

    :goto_3
    invoke-virtual {v9, v14, v15}, LA/Y3;->o(J)V
    ...
    invoke-static {v2, v12}, Ll4/l;->c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :cond_6
    :goto_5
    iput-boolean v11, v1, LA/c4$b;->h:Z
    ...
    iget-boolean v0, v1, LA/c4$b;->h:Z

    if-eqz v0, :cond_e

    invoke-static {v2, v6}, LA/Y3;->i(Landroid/content/Context;Landroid/content/ContentResolver;)LA/Y3;
    ...
    iget-object v6, v0, LA/Y3;->a:Landroid/net/Uri;
    ...
    :cond_d
    iput-boolean v11, v1, LA/c4$b;->i:Z
    ...
    :cond_f
    new-array v8, v11, [LA/Y3;

    const/4 v9, 0x2

    iput v9, v1, LA/c4$b;->n:I
    ...
    invoke-static {v12}, LA/Y3;->h(Landroid/content/ContentResolver;)LA/Y3$a;
    ...
    invoke-static/range {v16 .. v17}, LA/Y3;->j(J)LA/Y3;
    ...
    :cond_14
    iget-boolean v13, v9, LA/Y3$a;->i:Z
    ...
    iget-wide v10, v4, LA/Y3$a;->c:J

    invoke-static {v10, v11}, LA/Y3;->j(J)LA/Y3;
    ...
    iget-object v2, v10, LA/Y3;->a:Landroid/net/Uri;
    ...
    iget-object v10, v4, LA/Y3$a;->d:Landroid/net/Uri;
    ...
    invoke-static {v10, v0}, LA/z2;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, v4, LA/Y3$a;->e:Ljava/lang/String;
    ...
    iget v13, v4, LA/Y3$a;->b:I

    move-object/from16 v21, v6

    move-object/from16 v20, v7

    iget-wide v6, v4, LA/Y3$a;->a:J
    ...
    invoke-static {v2, v6, v7, v13, v10}, LA/Y3;->l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, v6, v7, v13, v10}, LA/Y3;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget v0, v4, LA/Y3$a;->f:I

    iget v2, v4, LA/Y3$a;->g:I

    invoke-static {v0, v2, v13, v10}, LA/Y3;->m(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v9, LA/Y3$a;->d:Landroid/net/Uri;
    ...
    iget-object v2, v9, LA/Y3$a;->d:Landroid/net/Uri;
    ...
    :cond_1d
    iget-object v0, v9, LA/Y3$a;->e:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, LA/Y3;->e(Landroid/content/Context;Landroid/net/Uri;)LA/Y3;

    move-result-object v2

    if-eqz v2, :cond_1f

    iget-object v0, v2, LA/Y3;->b:Landroid/graphics/Bitmap;
    ...
    :cond_20
    :goto_11
    iget-object v0, v4, LA/Y3$a;->d:Landroid/net/Uri;

    invoke-static {v12, v0}, Ljc/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {v0, v3}, LA/z2;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2, v6, v6}, LA/Y3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/Y3;
    ...
    iget-boolean v2, v4, LA/Y3$a;->h:Z

    if-eqz v2, :cond_21

    const/4 v2, 0x1

    iput-boolean v2, v0, LA/Y3;->e:Z

    iget v2, v4, LA/Y3$a;->f:I

    iput v2, v0, LA/Y3;->i:I

    iget v2, v4, LA/Y3$a;->g:I

    iput v2, v0, LA/Y3;->j:I

    :cond_21
    iget-wide v2, v4, LA/Y3$a;->j:J

    invoke-virtual {v0, v2, v3}, LA/Y3;->o(J)V
    ...
    invoke-static {v3, v0, v14}, LA3/h2;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :goto_15
    iput-boolean v3, v1, LA/c4$b;->i:Z
    ...
    invoke-static {v7, v3}, Ljc/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    :cond_2c
    iput-boolean v2, v1, LA/c4$b;->j:Z
    ...
    iget-wide v2, v1, LA/Y3$a;->c:J

    goto :goto_1c

    :goto_1d
    invoke-virtual {v4, v2, v3}, LA/Y3;->p(J)V
    ...
    :cond_30
    iget-boolean v3, v1, LA/Y3$a;->i:Z

    :goto_1e
    iput-boolean v3, v4, LA/Y3;->h:Z
    ...
    :cond_32
    iget-wide v3, v1, LA/Y3$a;->c:J

    :goto_20
    invoke-virtual {v0, v3, v4}, LA/Y3;->p(J)V
...
.method public final h(Ljava/lang/Object;)V
    ...
    iget-boolean v2, p0, LA/c4$b;->j:Z
    ...
    iget-object v0, p0, LA/c4$b;->l:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v1, p0, LA/c4$b;->j:Z
    ...
    :cond_1
    iget-object v1, v0, LA/c4;->a:LA/Y3;
    ...
    iget-boolean p0, p0, LA/c4$b;->i:Z

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1, v2, p0}, LA/c4;->g(LA/Y3;ZZZ)V
