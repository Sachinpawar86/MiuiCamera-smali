...
.field public final f:LA/a3$a;

.field public final g:LA/B2;

.field public final h:LA/p0;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, LA/a3;->c:Z

    new-instance v0, LA/a3$a;

    invoke-direct {v0, p0}, LA/a3$a;-><init>(LA/a3;)V

    iput-object v0, p0, LA/a3;->f:LA/a3$a;
    ...
    iput-object v0, p0, LA/a3;->g:LA/B2;

    new-instance v0, LA/p0;

    invoke-direct {v0, p0, v1}, LA/p0;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, LA/a3;->h:LA/p0;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, LA/a3;->a:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lcom/android/camera/Camera;LA/Y3;Landroid/net/Uri;Landroid/graphics/Rect;F)Landroid/content/Intent;
    .locals 8
    ...
    sget-object p2, LA/H2$a;->a:LA/H2;

    iget p2, p2, LA/H2;->g:F
    ...
    iget-boolean p2, p1, LA/Y3;->e:Z

    if-eqz p2, :cond_d

    iget p2, p1, LA/Y3;->i:I
    ...
    invoke-static {p2, v5}, LA/O;->d(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3, p2}, LA/O;->e(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, L롅롉롋레롋롏레롂롃롐롏롅롃레롅롉롋롋롉롈레롥롉롋롋롉롈;->d2()Z
...
.method public static b(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Ljc/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v2, v0, p0}, LA/M;->d(Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/String;
...
.method public static d(Lcom/android/camera/Camera;LA/Y3;Landroid/net/Uri;)Z
    .locals 7
    ...
    invoke-virtual {p0, v2}, LA/c4;->d(Z)V
    ...
    invoke-static {p2, v3}, LA/z2;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v3, LA/c4;->k:Landroid/net/Uri;
    ...
    iget-object v3, v3, LA/c4;->k:Landroid/net/Uri;
    ...
    invoke-static {v3, p2}, Ljc/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p2}, Ljc/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
...
# virtual methods
.method public final c(LA/Y3;Lcom/android/camera/Camera;)V
    .locals 8
    .param p1    # LA/Y3;
    ...
    iget-object v3, p2, Lcom/android/camera/ActivityBase;->j0:Lo5/f;
    ...
    invoke-virtual {v4}, L롅롉롋레롋롏레롂롃롐롏롅롃레롅롉롋롋롉롈레롥롉롋롋롉롈;->y5()Z
    ...
    :cond_4
    :goto_1
    iget-object p2, p0, LA/a3;->b:Landroid/os/Messenger;
    ...
    invoke-virtual {p2}, L롅롉롋레롋롏레롂롃롐롏롅롃레롅롉롋롋롉롈레롥롉롋롋롉롈;->d2()Z

    move-result p2

    if-eqz p2, :cond_7

    iget p2, p1, LA/Y3;->m:I
    ...
    :cond_7
    :goto_2
    sget-object p2, LA/P3;->f:LA/P3$a;
    ...
    :try_start_0
    iget-object v4, p1, LA/Y3;->a:Landroid/net/Uri;

    iget-object v5, p1, LA/Y3;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p2, v4, v5}, LA/P3;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_8
    :try_start_1
    invoke-virtual {p2}, LA/P3;->c()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v2, p0, LA/a3;->b:Landroid/os/Messenger;
    ...
    :try_start_3
    iget-object v7, p2, LA/P3;->e:Landroid/net/Uri;
    :try_end_3
    ...
    iget-object p1, p1, LA/Y3;->n:Ljava/lang/Boolean;
    ...
    iget-object p1, p0, LA/a3;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, LA/a3;->b:Landroid/os/Messenger;
