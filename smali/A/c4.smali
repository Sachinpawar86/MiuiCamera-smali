...
# instance fields
.field public a:LA/Y3;

.field public b:LA/c4$b;
...
.field public g:LA/c4$a;

.field public h:LA/c4$d;
...
.method public final c()V
    ...
    iget-object v3, p0, LA/c4;->c:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    iget-object v1, p0, LA/c4;->b:LA/c4$b;
    ...
    iget-object v0, p0, LA/c4;->b:LA/c4$b;

    invoke-virtual {v0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->d()V

    :cond_1
    new-instance v8, LA/c4$b;

    iget-object v5, p0, LA/c4;->a:LA/Y3;
    ...
    invoke-direct/range {v0 .. v5}, LA/c4$b;-><init>(ZZLjava/lang/ref/WeakReference;LA/c4;LA/Y3;)V
    ...
    iput-object v8, p0, LA/c4;->b:LA/c4$b;
...
.method public final e(Landroid/net/Uri;J)V
    ...
    iget-object v0, p0, LA/c4;->k:Landroid/net/Uri;
    ...
    :cond_1
    iput-object v0, p0, LA/c4;->k:Landroid/net/Uri;
    ...
    iget-object p0, p0, LA/c4;->k:Landroid/net/Uri;
...
.method public final f()V
    ...
    iget-object v0, p0, LA/c4;->c:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    iget-object v2, p0, LA/c4;->a:LA/Y3;

    if-eqz v2, :cond_1

    iget-boolean v2, v2, LA/Y3;->c:Z

    if-nez v2, :cond_1

    new-instance v2, LA/c4$c;

    invoke-direct {v2, v0}, LA/c4$c;-><init>(Ljava/lang/ref/WeakReference;)V
...
.method public final g(LA/Y3;ZZZ)V
    .locals 0

    iput-object p1, p0, LA/c4;->a:LA/Y3;

    if-eqz p2, :cond_0

    invoke-virtual {p0, p3, p4}, LA/c4;->h(ZZ)V

    :cond_0
    if-eqz p1, :cond_1

    iget-object p1, p1, LA/Y3;->a:Landroid/net/Uri;

    iput-object p1, p0, LA/c4;->k:Landroid/net/Uri;
...
.method public final h(ZZ)V
    ...
    invoke-direct/range {v1 .. v6}, LA/a4;-><init>(LA/c4;Lcom/android/camera/ActivityBase;ZIZ)V

    invoke-static {v0, v7}, LBc/a;->A(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
