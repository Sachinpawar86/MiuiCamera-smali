...
.method static constructor <clinit>()V
    ...
    sput-object v0, LA/Y3;->p:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public static b(Landroid/database/Cursor;)LA/Y3$a;
    .locals 19
    ...
    invoke-static {v2, v3}, Ljc/z;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct/range {v4 .. v16}, LA/Y3$a;-><init>(JIJLjava/lang/String;IIZZJ)V
    :try_end_1
...
.method public static c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/Y3;
    .locals 11
    ...
    :cond_0
    new-instance v3, LA/Y3;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-boolean v1, v3, LA/Y3;->c:Z

    iput-boolean v1, v3, LA/Y3;->d:Z

    iput-boolean v1, v3, LA/Y3;->e:Z

    iput-boolean v1, v3, LA/Y3;->h:Z

    const/4 v4, -0x1

    iput v4, v3, LA/Y3;->i:I

    iput v4, v3, LA/Y3;->j:I

    const-wide/16 v4, -0x1

    iput-wide v4, v3, LA/Y3;->k:J

    iput-boolean v1, v3, LA/Y3;->l:Z

    iput-object v0, v3, LA/Y3;->n:Ljava/lang/Boolean;

    const/4 v4, 0x1

    iput-boolean v4, v3, LA/Y3;->o:Z

    iput-object p0, v3, LA/Y3;->a:Landroid/net/Uri;
    ...
    :goto_2
    iput-object p1, v3, LA/Y3;->b:Landroid/graphics/Bitmap;

    return-object v3
.end method

.method public static d([BIILandroid/net/Uri;)LA/Y3;
    .locals 4
    ...
    :cond_2
    invoke-static {p3, v0, p1, v1}, LA/Y3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/Y3;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;)LA/Y3;
    .locals 25
    ...
    invoke-static {v7, v1}, LA/z2;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v4, v5, v10}, LA/Y3;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v14, v5, v10}, LA/Y3;->m(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v18 .. v24}, LA/Y3;->f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    :goto_c
    invoke-static {v7, v0, v1, v1}, LA/Y3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/Y3;

    move-result-object v0

    if-eqz v0, :cond_10

    invoke-virtual {v0, v8, v9}, LA/Y3;->o(J)V
...
.method public static f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p1 .. p6}, LA/Y3;->g(Landroid/media/MediaMetadataRetriever;IIIILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p2}, LA/S;->f(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static h(Landroid/content/ContentResolver;)LA/Y3$a;
    .locals 11
    ...
    invoke-static {v3, v4}, LA/G2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, LA/G2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, LA/w3;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v6}, LA/Y3;->b(Landroid/database/Cursor;)LA/Y3$a;
    ...
    invoke-static {p0}, LA/Y3;->b(Landroid/database/Cursor;)LA/Y3$a;
...
.method public static i(Landroid/content/Context;Landroid/content/ContentResolver;)LA/Y3;
    .locals 23
    ...
    sget-object v2, LA/Y3;->p:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v15}, Ljc/I;->a(Ljava/io/Closeable;)V

    invoke-static {v12}, Ljc/I;->a(Ljava/io/Closeable;)V

    invoke-static {v14}, Ljc/I;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v1, v4}, Ljc/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z

    move-result v1

    if-eqz v1, :cond_7

    invoke-static {v0, v4}, Ll4/l;->c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v4, v0, v1, v1}, LA/Y3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/Y3;

    move-result-object v0

    if-eqz v0, :cond_b

    iput-boolean v5, v0, LA/Y3;->e:Z

    iput v2, v0, LA/Y3;->i:I

    iput v9, v0, LA/Y3;->j:I

    const/4 v1, 0x1

    iput-boolean v1, v0, LA/Y3;->c:Z

    iput-boolean v7, v0, LA/Y3;->h:Z

    invoke-virtual {v0, v10, v11}, LA/Y3;->o(J)V

    sget v1, LA/Y3;->r:I

    iput v1, v0, LA/Y3;->m:I
    ...
    invoke-static/range {v16 .. v16}, Ljc/I;->a(Ljava/io/Closeable;)V
...
.method public static j(J)LA/Y3;
    .locals 18
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {v1, v2, v0}, LA/G2;->b(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lmd/d;->b:Ljava/lang/Object;
    ...
    iget-object v10, v10, Ltj/a;->b:LEg/b;

    iget-object v10, v10, LEg/b;->a:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lxj/a;->b:Laa/s;

    iget-object v0, v0, Laa/s;->b:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v0, v6}, LA/Y3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/Y3;
    ...
    invoke-virtual {v0, v1, v2}, LA/Y3;->o(J)V
...
.method public static k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p0 .. p4}, LA/Y3;->l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
...
.method public final o(J)V
    ...
    iput-wide p1, p0, LA/Y3;->k:J

    const-string/jumbo v0, "setFileSize: "

    const-string v1, ", mUri: "

    invoke-static {p1, p2, v0, v1}, LA/W;->g(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, p0, LA/Y3;->a:Landroid/net/Uri;
...
.method public final p(J)V
    ...
    iput-object v0, p0, LA/Y3;->f:Ljava/lang/String;
    ...
    iput-object p1, p0, LA/Y3;->g:Ljava/lang/String;
...
.method public final q(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, LA/Y3;->a:Landroid/net/Uri;
    ...
    invoke-static {p1, v0}, LA/z2;->h(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, LA/Y3;->a:Landroid/net/Uri;

    iput-boolean v2, p0, LA/Y3;->d:Z
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, LA/Y3;->a:Landroid/net/Uri;
    ...
    iget-object v1, p0, LA/Y3;->b:Landroid/graphics/Bitmap;
    ...
    iget-boolean p0, p0, LA/Y3;->l:Z

    const/16 v1, 0x7d

    invoke-static {v0, p0, v1}, Landroidx/appcompat/app/h;->j(Ljava/lang/StringBuilder;ZC)Ljava/lang/String;
